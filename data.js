...
//    layout : "full-bleed" | "padded"
//    hero   : boolean        — true → 뷰포트 높이 꽉 차는 대형 이미지
//    count  : 1 | 2 | 3     — 한 줄 이미지 개수
//    images : (string|null)[] — 이미지 경로. null → 회색 플레이스홀더
...
export const projects = [
    {
        ...
        imageBlocks: [
            { layout: "full-bleed", hero: true, count: 1, images: ["./projects/32teeth/hero.jpg"] }
        ],
        thumbnail16x9: "./projects/32teeth/thumb-16x9.jpg",
        thumbnail9x16: "./projects/32teeth/thumb-9x16.jpg",
    ...
    
    {
        ...
        imageBlocks: [
            { layout: "full-bleed", hero: true, count: 1, images: ["./projects/yeolmu/hero.jpg"] }
        ],
        thumbnail16x9: "./projects/yeolmu/thumb-16x9.jpg",
        thumbnail9x16: "./projects/yeolmu/thumb-9x16.jpg",
    ...
    
    {
        ...
        imageBlocks: [
            { layout: "full-bleed", hero: true, count: 1, images: ["./projects/grandma/hero.jpg"] }
        ],
        thumbnail16x9: "./projects/grandma/thumb-16x9.jpg",
        thumbnail9x16: "./projects/grandma/thumb-9x16.jpg",
        websiteLink: null,
    ...
    
    {
        ...
        imageBlocks: [
            { layout: "full-bleed", hero: true, count: 1, images: ["./projects/SNUDcatalog/hero.jpg"] }
        ],
        thumbnail16x9: "./projects/SNUDcatalog/thumb-16x9.jpg",
        thumbnail9x16: "./projects/SNUDcatalog/thumb-9x16.jpg",
    ...
    
    {
        ...
        imageBlocks: [
            { layout: "full-bleed", hero: true, count: 1, images: ["./projects/25kms/hero.jpg"] }
        ],
        thumbnail16x9: "./projects/25kms/thumb-16x9.jpg",
        thumbnail9x16: "./projects/25kms/thumb-9x16.jpg",
        websiteLink: null,
    ...
    
    {
        ...
        content:     { leftCol: [], rightCol: [] },
        imageBlocks: [
            { layout: "full-bleed", hero: true, count: 1, images: ["./projects/minhwaMV/hero.jpg"] }
        ],
        thumbnail16x9: "./projects/minhwaMV/thumb-16x9.jpg",
        thumbnail9x16: "./projects/minhwaMV/thumb-9x16.jpg",
    ...
    
    {
        ...
        imageBlocks: [
            { layout: "full-bleed", hero: true, count: 1, images: ["./projects/sac/hero.jpg"] }
        ],
        thumbnail16x9: "./projects/sac/thumb-16x9.jpg",
        thumbnail9x16: "./projects/sac/thumb-9x16.jpg",
        websiteLink: null,
    ...
    
    {
        ...
        content:     { leftCol: [], rightCol: [] },
        imageBlocks: [
            { layout: "full-bleed", hero: true, count: 1, images: ["./projects/puresoon/hero.jpg"] }
        ],
        thumbnail16x9: "./projects/puresoon/thumb-16x9.jpg",
        thumbnail9x16: "./projects/puresoon/thumb-9x16.jpg",
        websiteLink: null,
    ...
    
    {
        ...
        imageBlocks: [
            { layout: "full-bleed", hero: true, count: 1, images: ["./projects/img-objectifier/hero.jpg"] }
        ],
        thumbnail16x9: "./projects/img-objectifier/thumb-16x9.jpg",
        thumbnail9x16: "./projects/img-objectifier/thumb-9x16.jpg",
